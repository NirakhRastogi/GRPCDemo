...
public final class HelloServiceGrpc {
    ...
    public static final String SERVICE_NAME = "com.grpc.GRPCDemo.HelloService";

    // Static method descriptors that strictly reflect the proto.
    private static volatile io.grpc.MethodDescriptor<com.grpc.GRPCDemo.HelloRequest,
            com.grpc.GRPCDemo.HelloResponse> getHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "hello",
            requestType = com.grpc.GRPCDemo.HelloRequest.class,
            responseType = com.grpc.GRPCDemo.HelloResponse.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.grpc.GRPCDemo.HelloRequest,
            com.grpc.GRPCDemo.HelloResponse> getHelloMethod() {
        io.grpc.MethodDescriptor<com.grpc.GRPCDemo.HelloRequest, com.grpc.GRPCDemo.HelloResponse> getHelloMethod;
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
            synchronized (HelloServiceGrpc.class) {
                if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
                    HelloServiceGrpc.getHelloMethod = getHelloMethod =
                            io.grpc.MethodDescriptor.<com.grpc.GRPCDemo.HelloRequest, com.grpc.GRPCDemo.HelloResponse>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                                    .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.grpc.GRPCDemo.HelloRequest.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.grpc.GRPCDemo.HelloResponse.getDefaultInstance()))
    ...
    public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
         ...
         *
         */
        public void hello(com.grpc.GRPCDemo.HelloRequest request,
                          io.grpc.stub.StreamObserver<com.grpc.GRPCDemo.HelloResponse> responseObserver) {
        ...
        public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            asyncUnaryCall(
                                    new MethodHandlers<
                                            com.grpc.GRPCDemo.HelloRequest,
                                            com.grpc.GRPCDemo.HelloResponse>(
                                            this, METHODID_HELLO)))
                    .build();
        }
    }
    ...
    public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
         ...
         *
         */
        public com.grpc.GRPCDemo.HelloResponse hello(com.grpc.GRPCDemo.HelloRequest request) {
    ...
    public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
         ...
         *
         */
        public com.google.common.util.concurrent.ListenableFuture<com.grpc.GRPCDemo.HelloResponse> hello(
                com.grpc.GRPCDemo.HelloRequest request) {
    ...
    private static final class MethodHandlers<Req, Resp> implements
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_HELLO:
                    serviceImpl.hello((com.grpc.GRPCDemo.HelloRequest) request,
                            (io.grpc.stub.StreamObserver<com.grpc.GRPCDemo.HelloResponse>) responseObserver);
                    break;
                default:
    ...
    private static abstract class HelloServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.grpc.GRPCDemo.HelloServiceOuterClass.getDescriptor();
        }
